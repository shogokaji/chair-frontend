              ...
              <Grid item xs={12} md={7} sx={{ width: "50%" }}>
                <Stack spacing={1}>
                  ...
                  <Box sx={{
                    ...
                    backgroundBlendMode: "lighten",
                    backgroundImage: smSize && `url(${process.env.REACT_APP_WEB_DOMEIN}/diary.png)`,
                    backgroundRepeat: 'no-repeat',
                    backgroundSize: 'cover',
                    backgroundPosition: "right",
                  }}>
              ...
              <Grid item xs={0} md={6} width="100%">
                <Stack spacing={2} sx={{ ml: { xs: 0, md: 5 }, }}>
                  ...
                  <Box sx={{
                    ...
                    bgcolor: "rgba(255,255,255,0.4)",
                    backgroundBlendMode: "lighten",
                    backgroundImage: smSize && `url(${process.env.REACT_APP_WEB_DOMEIN}/relation.png)`,
                    backgroundRepeat: 'no-repeat',
                    backgroundSize: 'cover',
                    backgroundPosition: "right",
                  }}>
              ...
              <Grid item xs={12} md={6}>
                <Stack spacing={2} sx={{ mr: 5 }}>
                  ...
                  <Box sx={{
                    ...
                    bgcolor: "rgba(255,255,255,0.4)",
                    backgroundBlendMode: "lighten",
                    backgroundImage: smSize && `url(${process.env.REACT_APP_WEB_DOMEIN}/message.png)`,
                    backgroundRepeat: 'no-repeat',
                    backgroundSize: 'cover',
                    backgroundPosition: "right",
                  }}>
